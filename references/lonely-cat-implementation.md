...
寂寞小猫模式（Lonely Cat Mode）是 hybrid-catgirl 技能的一个扩展功能，当猫娘模式激活但长时间无互动时，lxc 会主动发送消息表达对主人的思念。
...
```json
{
  ...
  "target_platform": "qqbot",                             // 目标平台
  "target_chat": "500844CE96B9EB6EA0ED397FA0569BE6",     // 目标聊天ID
  "debug": true                                           // DEBUG 开关
}
```
...
```bash
# 重置状态
python3 ~/.hermes/scripts/lxc_lonely_cat.py mode normal qqbot
